...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'workspace.billingPage.billing.cancelConfirm':
    'Subscription will keep running until the end of the current billing cycle, then stop renewing.',
  ...
  'workspace.billingPage.billing.invoice.nonOwner':
    'Only workspace owners can view invoice history.',
  ...
  'workspace.billingPage.billing.invoice.title': 'Invoice history',
  'workspace.billingPage.billing.manage.cancelItem': 'Cancel at period end',
  'workspace.billingPage.billing.manage.cta': 'Manage',
  'workspace.billingPage.billing.manage.downgradeItem': 'Downgrade to Solo…',
  ...
  'workspace.billingPage.usage.summaryTitle': 'Workspace usage',
  ...
  'workspaceSetting.tab.billing': 'Billing',
